...
class DecisionTreeClassification(object):
    ...
    def __init__(self, data, dependant_var, indivisualInputs, criterion, unwanted_cols = None, testsize = None):
        ...
        self.criterion = criterion if criterion != 'null' and criterion != 'undefined' else 'gini'
    ...
    def draw_graph(self, filename1, filename2, filename3):
        title1 = "Decission Tree Classification Training Data set"
        title2 = "Decission Tree Classification Testing Data set"
