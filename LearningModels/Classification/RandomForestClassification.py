...
class RandomForestClassification(object):
    ...
    def __init__(self, data, dependant_var, indivisualInputs, criterion_rfc, nestimators_rfc, unwanted_cols = None, testsize = None):
        ...
        self.criterion = criterion_rfc if criterion_rfc != 'null' and criterion_rfc != 'undefined' else 'gini'
        self.nestimators = int(float(nestimators_rfc)) if  nestimators_rfc != 'null' else 10
        self.classifier = RandomForestClassifier(criterion=self.criterion, n_estimators=self.nestimators, random_state=0)
        self.scaler = None
    ...
    def draw_graph(self, filename1, filename2, filename3):
        title1 = "Support Vector Regression Testing Data set"
        title2 = "Support Vector Testing Data set"
