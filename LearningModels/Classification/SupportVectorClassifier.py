...
class SupportVectorClassification(object):
    ...
    def __init__(self, data, dependant_var, indivisualInputs, kerneloptSvc, unwanted_cols = None, testsize = None):
        ...
        self.kernelopt = kerneloptSvc if kerneloptSvc is not None else 'linear'
